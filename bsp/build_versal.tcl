...
set script_file "build_versal.tcl"
...
# Create project
create_project ${_xil_proj_name_} ./vivado -part xcvc1902-vsva2197-2MP-e-S
...
set_property -name "board_part" -value "xilinx.com:vck190:part0:3.3" -objects $obj
